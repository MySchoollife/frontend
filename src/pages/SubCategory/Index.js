...
function Index() {
  ...
  const columns = [
    ...
    {
      title: lang("Sub Category Name Arabic"),
      dataIndex: "ar_name",
      key: "ar_name",
      render: (_, { ar_name }) => {
      ...
      request({
        url:
          ...
          `?status=${filterActive ? filterActive.join(",") : ""}&page=${
            ...
            pagination ? pagination.pageSize : 100000
          }&search=${debouncedSearchText}`,
        method: "GET",
    ...
    <>
            ...
            <div className="w-100 text-head_right_cont">
              <div className="pageHeadingSearch">
                <Input.Search
                  ...
                  placeholder={lang("Search by Sub Category name")}
                  onChange={onSearch}
                  allowClear
                />
              </div>
      ...
      {showMessage && (
        <DeleteModal
          title={lang("Delete Sub Category")}
          subtitle={lang(
            "This category contains service, please remove  this service from services  before deleting Sub category",
          )}
          show={showMessage}
          hide={() => {
      ...
      {showStatusMessage && (
        <DeleteModal
          ...
          subtitle={lang(
            "This category contains  active service, please inactive services  before deactivating Sub category",
          )}
