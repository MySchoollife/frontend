            ...
            {loading ? (
              ...
              <div className="view-main-list">
                <div className="view-inner-cls">
                  ...
                  <h6>
                    <span className="cap">
                      {list && list?.user_id && list?.user_id?.name
                        ? list?.user_id?.name
                        : "-"}
                    </span>
                  </h6>
                ...
                <div className="view-inner-cls">
                  ...
                  <h6>
                    {list?.user_id
                      ? "+" + list?.user_id?.country_code + "-"
                      : "+965"}
                    {list?.user_id ? list?.user_id?.mobile_number : "-"}
                  </h6>
                </div>
                ...
                {list?.vehicle_id && (
                  <>
                      ...
                      <h6>
                        {list && !list?.vehicle_id?.image ? (
                          ...
                          <Image
                            ...
                            src={apiPath.assetURL + list?.vehicle_id?.image}
                          />
                        )}
                      </h6>
                    </div>
                    ...
                    <div className="view-inner-cls">
                      ...
                      <h6>
                        {list?.vehicle_id ? list?.vehicle_id?.vin_number : "-"}
                      </h6>
                    </div>
                    <div className="view-inner-cls">
            ...
            {loading ? (
              ...
              <div className="view-main-list">
                <div className="view-inner-cls">
                  ...
                  <h6>
                    {list && !list?.image ? (
                      ...
                      <Image
                        className="image-radius"
                        src={apiPath.assetURL + list?.image}
                      />
                    )}
                  </h6>
                </div>
                ...
                <div className="view-inner-cls">
                  ...
                  <h6>
                    <span className="cap">
                      {list && list?.category_id && list?.category_id?.name
                        ? list?.category_id?.name
                        : "-"}
                    </span>
                  </h6>
                </div>
                ...
                <div className="view-inner-cls">
                  ...
                  <h6>
                    <span className="cap">
                      {list && list?.part_number ? list?.part_number : "-"}
                    </span>
                  </h6>
                </div>
                ...
                <div className="view-inner-cls">
                  ...
                  <h6>
                    <span className="cap">
                      {list && list?.description ? list?.description : "-"}
                    </span>
                  </h6>
                </div>
                ...
                <div className="view-inner-cls">
                  ...
                  <h6>
                    {list?.status == "fulfill" ? (
                      <Badge status="success" text="Fulfill" />
                    ) : list?.status == "received" ? (
                      <Badge status="processing" text="Received" />
                    ) : (
                      <Badge status="warning" text="Request" />
                    )}
                  </h6>
                </div>
              ...
              <div className="view-main-list">
                <div className="view-inner-cls">
                  ...
                  <h6>
                    <span className="cap">
                      {list &&
                      list?.quote_reply_id?.vendor_id &&
                      list?.quote_reply_id?.vendor_id?.name
                        ? list?.quote_reply_id?.vendor_id?.name
                        : "-"}
                    </span>
                  </h6>
                ...
                <div className="view-inner-cls">
                  <h5>
                    {list?.quote_reply_id?.vendor_id?.type ?? ""} Phone Number:
                  </h5>
                  <h6>
                    {list?.quote_reply_id?.vendor_id
                      ? "+" +
                        list?.quote_reply_id?.vendor_id?.country_code +
                        "-"
                      : "+965"}
                    {list?.quote_reply_id?.vendor_id
                      ? list?.quote_reply_id?.vendor_id?.mobile_number
                      : "-"}
                  </h6>
                </div>
                <div className="view-inner-cls">
                  <h5>
                    {list?.quote_reply_id?.vendor_id?.type ?? ""} Location:
                  </h5>
                  <h6>
                    {list?.quote_reply_id?.vendor_id
                      ? list?.quote_reply_id?.vendor_id?.location
                      : "-"}
                  </h6>
                </div>
                <div className="view-inner-cls">
                  <h5> Amount:</h5>
                  <h6>
                    {list?.quote_reply_id ? list?.quote_reply_id?.price : "-"}
                  </h6>
                </div>
              </div>
            </Col>
